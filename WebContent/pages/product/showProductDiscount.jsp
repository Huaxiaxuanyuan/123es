...
<%
	...
	originalList = dao.selectProductsDiscount(new Integer(0));
...
<%
	for(int i=start;i<over;i++){
		ProductEntity e = (ProductEntity)originalList.get(i);
...
<table width="95%" height="136" border="1" align="center" cellpadding="1"
		...
		<tr>
			...
			<td width="59%"  height="100%" bgcolor="#FFFFFF">
				...
				<div align="left" style="text-decoration:line-through;color:#FF0000">原价：<%=e.getMarketPrice() %>元</div>
				<div align="left">现价：<%=e.getSellPrice() %>元</div>
...
<div align="center">
	...
	<a href="showProductDiscount.jsp?pageNum=<%=number-1%>">上一页</a>
	</td>
	...
	<a href="showProductDiscount.jsp?pageNum=<%=number+1%>">下一页</a>
	</td>
	<%}%>
	</td>
	</tr>
